...
% Playing tone 1 and tone 2 alternatively 8 times in mono fashion
y = repmat([tone_1 tone_2], 1, 8);
sound(y, fs)

% Playing tone 1 and tone 2 alternatively 8 times in two
% stereo channels
channel_1 = [tone_1 zeros(1, numel(tone_2))];
channel_2 = [zeros(1, numel(tone_1)) tone_2];
y = repmat([channel_1; channel_2], 1, 8);
sound(y, fs)
