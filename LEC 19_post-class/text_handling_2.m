...
myCharArray = 'This is an input provided as a character array';
result = string(myCharArray)
whos
...
% Using a loop to tokenize the entire string
% Note that MATLAB suggest using the "split"
% function to do this more concisely.
str = "she sells sea shells in the sea shore";
tokens = {};
idx = 1;
while strlength(str) > 0
    [tokens{idx}, str] = strtok(str);
    idx = idx + 1;
end
tokens
