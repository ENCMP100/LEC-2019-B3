...
myCharArray1 = ['Joe'; 'Peter'; 'Fernando'; 'Jack']  % This does NOT work

myCharArray2 = char('Joe', 'Peter', 'Fernando', 'Jack') % This works but 
                                                 % it pads spaces
                                                 
myCharArray3 = ['Joe', 'Peter', 'Fernando', 'Jack'] 
                                                 
% Defining several words as an array of strings
myStringArray = ["Joe"; "Peter"; "Fernando"; "Jack"]

myStringArray2 = ["Joe", "Peter", "Fernando", "Jack"]
